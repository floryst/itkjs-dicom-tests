...
//
void  GDCMImageIOFactoryRegister__Private();void  JSONImageIOFactoryRegister__Private();
...
namespace {
  ...
  void (*ImageIOFactoryRegisterRegisterList[])(void) = {
    GDCMImageIOFactoryRegister__Private,JSONImageIOFactoryRegister__Private,
    nullptr};
